    ...
    <section className="relative w-full overflow-hidden bg-[#0E1725]">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 py-16 md:px-10 lg:px-16">
        <div className="mx-auto mb-10 flex max-w-3xl flex-col items-center text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-slate-200">
          ...
          {solutions.map((solution, index) => {
            ...
            return (
              <div
                ...
                className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 shadow-[0_20px_70px_-35px_rgba(0,0,0,0.8)] backdrop-blur"
              >
                <div
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center w-[155.95px] h-12 rounded-[10px] text-sm font-semibold transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0E1725] bg-[#1298E5] text-white shadow-lg"
                >
