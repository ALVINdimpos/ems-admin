...
export const mockContents: IMarketingContent[] = [
  ...
  // Additional FAQ content for landing page
  {
    id: generateId(),
    title: "How do I create my first event?",
    slug: "faq-create-first-event",
    type: "FAQ",
    status: "PUBLISHED",
    summary:
      "Learn how to create and set up your first event in just a few simple steps.",
    content:
      "Creating your first event is simple! Navigate to the Dashboard, click 'Create Event', fill in the event details including name, date, location, and description. You can also add tickets, set capacity limits, and customize registration forms. Once ready, publish your event to start accepting registrations.",
    priority: 100,
    isActive: true,
    viewCount: 3450,
    categoryId: mockCategories[4].id,
  ...
  },
  {
    ...
    status: "PUBLISHED",
    summary:
      "We support multiple payment gateways and methods for your convenience.",
    content:
      "Our platform supports all major payment methods including credit/debit cards (Visa, MasterCard, American Express), PayPal, Stripe, bank transfers, and mobile payment options like Apple Pay and Google Pay. You can configure multiple payment gateways and offer attendees flexible payment options.",
    priority: 95,
    isActive: true,
    viewCount: 2890,
    categoryId: mockCategories[4].id,
    ...
    createdAt: generateDate(28),
    updatedAt: generateDate(3),
    publishedAt: generateDate(26),
  },
  {
    id: generateId(),
    title: "Can I customize the registration form?",
    slug: "faq-customize-registration",
    type: "FAQ",
    status: "PUBLISHED",
    summary:
      "Yes! Create custom forms with various field types to collect the information you need.",
    content:
      "Absolutely! Our form builder allows you to create fully customized registration forms. Add text fields, dropdowns, checkboxes, file uploads, and more. You can set fields as required or optional, add validation rules, and create conditional logic to show/hide fields based on responses.",
    priority: 90,
    isActive: true,
    viewCount: 2100,
    categoryId: mockCategories[4].id,
    ...
    createdAt: generateDate(25),
    updatedAt: generateDate(5),
    publishedAt: generateDate(23),
  },
  {
    id: generateId(),
    title: "How do I manage event attendees?",
    slug: "faq-manage-attendees",
    type: "FAQ",
    status: "PUBLISHED",
    summary:
      "Access powerful tools to track, communicate with, and manage your event attendees.",
    content:
      "The Attendee Management dashboard gives you complete control over your participants. View registration details, check-in attendees, send bulk emails, export attendee lists, manage refunds, and track attendance in real-time. You can also segment attendees and send targeted communications.",
    priority: 85,
    isActive: true,
    viewCount: 1850,
    categoryId: mockCategories[4].id,
  ...
  },
  {
    ...
    status: "PUBLISHED",
    summary:
      "Yes, we offer mobile apps for both iOS and Android for organizers and attendees.",
    content:
      "We have dedicated mobile apps for both event organizers and attendees. Organizers can manage events, check-in attendees, and monitor analytics on the go. Attendees can browse events, register, access tickets, and receive real-time updates. Download from the App Store or Google Play.",
    priority: 80,
    isActive: true,
    viewCount: 1620,
    categoryId: mockCategories[4].id,
  ...
  {
    id: generateId(),
    title: "What analytics and reports are available?",
    slug: "faq-analytics-reports",
    type: "FAQ",
    status: "PUBLISHED",
    summary:
      "Get comprehensive insights with our advanced analytics and reporting tools.",
    content:
      "Our analytics suite provides detailed insights including registration trends, revenue reports, attendee demographics, check-in rates, email engagement metrics, and custom reports. Export data in multiple formats (CSV, Excel, PDF) and integrate with your favorite BI tools.",
    priority: 75,
    isActive: true,
    viewCount: 1340,
    categoryId: mockCategories[4].id,
